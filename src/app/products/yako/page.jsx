// src/app/products/yako/page.js
import Image from "next/image";
import Link from "next/link";

export default function YakoPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="lg:w-1/2">
            ...
            <h2 className="text-xl text-gray-400 mb-6">Yielding Autonomous Kitchen Operator</h2>
            <p className="text-xl text-gray-300 mb-8">Autonomous food delivery robot with levitation and adaptive AI.</p>
          </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-gray-300 mb-8">Y.A.K.O is our flagship autonomous delivery system designed specifically for food service, utilizing cutting-edge magnetic levitation technology for smooth, efficient deliveries.</p>
          
          {/* Features */}
          <h2 className="text-3xl font-bold text-blue-400 mb-6">Key Features</h2>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            {["Frictionless magnetic levitation system", "Adaptive pathfinding AI with obstacle avoidance", 
              "Temperature-controlled storage compartments", "Voice interaction in 12 languages", 
              "Self-charging capabilities"].map((feature, index) => (
          ...
          <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 mb-12">
            <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              {[
                ["Capacity", "Up to 15kg of cargo"],
                ["Speed", "12km/h maximum speed"],
                ["Battery Life", "18 hours of continuous operation"],
                ["Navigation", "LiDAR, computer vision, GPS, indoor positioning"]
              ].map(([key, value], index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {["Restaurant food delivery", "Hospital meal distribution", 
              "Campus food services", "Hotel room service automation"].map((useCase, index) => (
        ...
        <div className="text-center py-8 mb-16">
          <h2 className="text-3xl font-bold mb-4">Ready to experience Y.A.K.O?</h2>
